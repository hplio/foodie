...
FetchHook useFetchRestaurantFoods(String restaurantId) {
  final foodCategoryList = useState<List<FoodsModel>?>([]);
  ...
  Future<void> fetchData() async {
    ...
    try {
      Uri url = Uri.parse(
          '$appBaseUrl/api/foods/restaurant-foods/$restaurantId');
